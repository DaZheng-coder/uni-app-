...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"NoteOL","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 111:
/*!****************************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/components/uni-popup/popup.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 112:
/*!******************************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/components/uni-popup/message.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 12:
/*!******************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/common/api/index.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 批量自动导出文件
...
/***/ 13:
/*!********************************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/common/api sync nonrecursive .js$ ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 134:
/*!****************************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/components/uni-icons/icons.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 14:
/*!********************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/common/api/article.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.get_article_by_isPublic = exports.update_isPublic = exports.remove_article = exports.update_content = exports.get_article_by_id = exports.update_article_title = exports.add_article = exports.get_article_list = void 0;var _http = _interopRequireDefault(__webpack_require__(/*! ../http.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
// 添加文章或笔记
exports.get_article_list = get_article_list;var add_article = function add_article(data) {
  return (0, _http.default)({
    url: 'article',
    data: Object.assign({}, data, {
      type: 'add' }) });
...
// 修改文章或笔记的标题
exports.add_article = add_article;var update_article_title = function update_article_title(data) {
  return (0, _http.default)({
    url: 'article',
    data: Object.assign({}, data, {
      type: 'update' }) });
...
// 根据笔记的id获取对应的笔记
exports.update_article_title = update_article_title;var get_article_by_id = function get_article_by_id(data) {
  return (0, _http.default)({
    url: 'article',
    data: Object.assign({}, data, {
      type: 'getArticleById' }) });
...
// 根据笔记的id修改笔记
exports.get_article_by_id = get_article_by_id;var update_content = function update_content(data, isHidden) {
  return (0, _http.default)({
    url: 'article',
    data: Object.assign({}, data, {
      type: 'updateContent' }) },
...
// 删除文章
exports.update_content = update_content;var remove_article = function remove_article(data) {
  return (0, _http.default)({
    url: 'article',
    data: Object.assign({}, data, {
      type: 'remove' }) });
...
// 更新文章是否可视
exports.remove_article = remove_article;var update_isPublic = function update_isPublic(data) {
  return (0, _http.default)({
    url: 'article',
    data: Object.assign({}, data, {
      type: 'updateIsPublic' }) });
...
// 根据是否可视化获取文章
exports.update_isPublic = update_isPublic;var get_article_by_isPublic = function get_article_by_isPublic(data) {
  return (0, _http.default)({
    url: 'article',
    data: Object.assign({}, data, {
...
};exports.get_article_by_isPublic = get_article_by_isPublic;

/***/ }),

/***/ 15:
/*!*************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/common/http.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni, uniCloud) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = $http;function $http(options, hiddenLoading) {var
...
/***/ 17:
/*!*************************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/pages.json?{"type":"stat"} ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__8A03C79" };exports.default = _default;

/***/ }),

/***/ 18:
/*!*******************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/common/api/folder.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.remove_folder = exports.add_folder = exports.get_folder_list = void 0;var _http = _interopRequireDefault(__webpack_require__(/*! ../http.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

// 获取文件夹列表
var get_folder_list = function get_folder_list(data) {
  return (0, _http.default)({
    url: 'folder',
    data: Object.assign({}, data, {
      type: 'get' }) });
...
// 添加文件夹
exports.get_folder_list = get_folder_list;var add_folder = function add_folder(data) {
  return (0, _http.default)({
    url: 'folder',
    data: Object.assign({}, data, {
      type: 'add' }) });
...
// 删除文件夹
exports.add_folder = add_folder;var remove_folder = function remove_folder(data) {
  return (0, _http.default)({
    url: 'folder',
    data: Object.assign({}, data, {
      type: 'remove' }) });
...
/***/ 19:
/*!*****************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/common/api/user.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.get_user = exports.update_password = exports.update_avatar = exports.update_username = exports.add_user = exports.check_user = void 0;var _http = _interopRequireDefault(__webpack_require__(/*! ../http.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

// 确认用户登录
var check_user = function check_user(data) {
  return (0, _http.default)({
    url: 'user',
    data: Object.assign({}, data, {
      type: 'check' }) });
...
// 注册添加用户
exports.check_user = check_user;var add_user = function add_user(data) {
  return (0, _http.default)({
    url: 'user',
    data: Object.assign({}, data, {
      type: 'add' }) });
...
// 更改用户名
exports.add_user = add_user;var update_username = function update_username(data) {
  return (0, _http.default)({
    url: 'user',
    data: Object.assign({}, data, {
      type: 'updateUsername' }) });
...
// 更新头像
exports.update_username = update_username;var update_avatar = function update_avatar(data) {
  return (0, _http.default)({
    url: 'user',
    data: Object.assign({}, data, {
      type: 'updateAvatar' }) });
...
// 更新密码
exports.update_avatar = update_avatar;var update_password = function update_password(data) {
  return (0, _http.default)({
    url: 'user',
    data: Object.assign({}, data, {
      type: 'updatePassword' }) });
...
// 获取用户信息
exports.update_password = update_password;var get_user = function get_user(data) {
  return (0, _http.default)({
    url: 'user',
    data: Object.assign({}, data, {
      type: 'get' }) });
...
/***/ 20:
/*!*************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/store/index.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _Storage = _interopRequireDefault(__webpack_require__(/*! ../common/js/Storage.js */ 8));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // Vuex 状态管理
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    SET_USER: function SET_USER(state, user) {
      ...
      if (user) {
        // 如果user不为空,添加
        _Storage.default.localStorage.set('user', user);
      } else {
        // user为空,删除
        _Storage.default.localStorage.remove('user');
      }
    } },

  actions: {
    set_user: function set_user(_ref, user) {var commit = _ref.commit,state = _ref.state;
...
/***/ 22:
/*!***************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/utils/plugins.js ***!
  \***************************************************/
/*! no static exports found */
...
/***/ 4:
/*!*********************************************!*\
  !*** E:/HBuilderProjects/NoteOL/pages.json ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 8:
/*!*******************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/common/js/Storage.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {var Str = {};
/*
               * 判断字符串是否为空
               */
...
Str.localStorage = {
  /**
                      ...
                      */
  set: function set(key, value) {var second = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;var ctag = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  ...
  /**
      ...
      * @param ctag      组主键名
      */
  remove: function remove(key, ctag) {
    if (Str.isNotNull(ctag)) {
      if (Str.isNull(key)) {
        key = ctag;
      } else {
        var baseVal = this.get(ctag) || {};
        delete baseVal[key];
        if (JSON.stringify(baseVal) == '{}') key = ctag;else
        this.set(ctag, baseVal, null);
      }
    }
    if (localStorage != undefined) {
...
/***/ 87:
/*!****************************************************************************!*\
  !*** E:/HBuilderProjects/NoteOL/components/uni-swipe-action-item/mpwxs.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
